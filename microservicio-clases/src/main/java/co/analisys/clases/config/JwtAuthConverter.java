...
/**
 * Convierte el JWT de Keycloak en autoridades de Spring Security.
 * Extrae los roles del realm (realm_access.roles) y les añade el prefijo ROLE_ si no lo tienen.
 */
